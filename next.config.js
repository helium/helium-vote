  ...
  serverRuntimeConfig: {
    votes: [
      ...
      },
      {
        ...
        description:
          "This is a proposal to change how Proof-of-Coverage (PoC) Challenges are generated and submitted to the Helium blockchain that allows for further network scalability and lowers the hardware complexity/cost of Hotspots. Specifically, it moves the responsibility of PoC Challenge creation to Validators and consequently proposes moving the economic reward (0.9% of total HNT rewards) for creating Challenges to this group as well.\n\nHotspot owners will no longer have to deal with syncing, relaying and port forwarding, and hotspot bandwidth usage will drop dramatically. Hotspots' share of the reward pool will decrease from 70.1% to 69.2%, however the consistency of hotspot earnings and reliability of witnessing and beaconing should increase substantially.\n\nApproving this HIP implies that the community has reviewed the implementation and the relevant Chain Variables. We will consider this proposal as approved if it passes with 2/3 of the vote power by the deadline.\n\nJoin the conversation on Discord and see the #hip55-validator-challenges channel for more details.",
        outcomes: [
          {
            value: "For HIP 55",
