  ...
  serverRuntimeConfig: {
    votes: [
      ...
      },
      {
        ...
        description:
          "HIP 70 proposes an implementation of HIP 51, moving Proof-of-Coverage and Data Transfer Accounting to dedicated Helium Oracles, and simplifying the primary needs of the blockchain to payments and identity management. Because this change simplifies the on-chain needs of the Helium Network, it will be possible to migrate the Helium Network to other Layer 1 blockchains to improve the performance and utility of the network. Helium's core developer team proposes migrating the Helium Network to the Solana blockchain. The team selected the Solana blockchain over maintaining their own L1 for reasons including Solana's ecosystem of developers, chain compatibility, applications, Solana Mobile Stack, and integration teams.\n\nThe proposed changes in HIP 70 do not change the fundamentals of the Helium Network or HNT, but provide several benefits to the Helium Network: More rewards for Hotspot owners; more chances of mining; data transfer for devices would be faster, more reliable, and more scalable; more utility for HNT; and more ecosystem support.\n\nHNT and all other tokens (IOT, MOBILE, DC) will seamlessly migrate to Solana. Most users can be guided through the migration by the Helium Wallet app. The proposal removes the need for staked validators. Any validators in the process of unstaking at the time of migration will have their HNT in cooldown automatically converted to vote-escrowed (veHNT, as defined in passed HIP 51). The validator's unstaking cooldown period is reduced from 5 months to 3 months to support the transition to Solana. Any validators who remain staked or are staking veHNT in the first 7 days after the Solana transition get a 3x yield of veHNT.\n\nAll active Helium wallets will be seeded with enough SOL for 100 transactions to ensure a smooth transition to Solana.\n\nApproving this HIP implies that the community has reviewed the implementation. We would consider this proposal as approved if it passes with 2/3 of the vote power by the deadline.\n\nJoin the conversation on Discord and see the #hip‑70‑scaling‑the‑helium‑network channel for more details.",
        outcomes: [
          {
            value: "For HIP 70",
