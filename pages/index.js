      ...
      <a className="flex-shrink-0 min-w-96 w-full sm:w-96 sm:p-5 border outline-none border-opacity-0 sm:hover:border-opacity-100 border-hv-purple-500 border-dashed duration-100 transition-all">
        <div className="h-full w-full flex flex-col transition-all duration-150">
          <span className="pt-5 px-5 rounded-t-3xl bg-hv-gray-450 relative">
            ...
            <p className="text-gray-500 h-14 overflow-hidden text-sm leading-tight">
              {description}
            </p>
            <div className="absolute h-10 bottom-0 left-0 right-0 bg-gradient-to-t from-hv-gray-450 to-transparent" />
          </span>
          <div className="rounded-b-3xl bg-hv-gray-500 p-5 flex flex-col">
              ...
              <div className="flex flex-col">
                <span className="space-y-4">
                  <a
                    ...
                    target="_blank"
                    className="opacity-40 flex flex-row items-center justify-start hover:opacity-75 transition-all duration-150"
                  >
                    <svg
