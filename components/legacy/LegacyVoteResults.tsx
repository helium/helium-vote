...
import { Outcome } from "./LegacyVoteOption";
...
const LegacyVoteResults: React.FC<{
  votingResults: { outcomesResults?: ResolvedOutcome[] };
  outcomes: Outcome[];
  completed: Outcome[];
}> = ({ votingResults, outcomes, completed }) => {
...
export default LegacyVoteResults;
